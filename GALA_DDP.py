...
def main():
    ...
    for i in range(num_gpus):
        devices.append(i)
    print(devices)
    sg0 = dgl.load_graphs(f"NESA_2part/{args.dataset}_{args.model}_finalsg0_combo{args.gpus}_{args.edgelimit}.bin")[0][0]
    sg1 = dgl.load_graphs(f"NESA_2part/{args.dataset}_{args.model}_finalsg1_combo{args.gpus}_{args.edgelimit}.bin")[0][0]
